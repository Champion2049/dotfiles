...
This is a modified repo of the main [caelestia-dots/caelestia](https://github.com/caelestia-dots/caelestia) repository and contains the modified configs and files for my personal installation. This repo also includes an install script to install the entire dots.
